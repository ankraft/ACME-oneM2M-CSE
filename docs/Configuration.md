...
| checkTimeSeriesInterval  | Interval to check for missing timeSeriesInstances. This should be half as long as the shortest \<timeSeries> interval. Float.<br/>Default: 1.0 seconds                                         | cse.checkTimeSeriesInterval  |
