...
@requires(tinyDBBinding='acmecse.plugins.database.TinyDBBinding', required=False)
@requires(postgreSQLBinding='acmecse.plugins.database.PostgreSQLBinding', required=False)
