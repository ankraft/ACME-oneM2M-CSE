...
def startup(args:argparse.Namespace, **kwargs:Dict[str, Any]) -> bool:
	...
	try:
		...
		pluginManager.provide('acmecse.services.RequestManager', request)
		pluginManager.provide('acmecse.services.SecurityManager', security)
		pluginManager.provide('acmecse.services.Validator', validator)
		pluginManager.provide('acmecse.runtime.ScriptManager', script)
		pluginManager.provide('acmecse.runtime.Management', managementSupport)
...
@provide('acmecse.runtime.CSE.shutdown')
def shutdown() -> None:
...
@provide('acmecse.runtime.CSE.forceShutdown')
