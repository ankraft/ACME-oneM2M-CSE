...
- [CSE] Makjor internal code restructuring to move most of the CSE's functionality to plugins. This allows for better modularity and extensibility of the CSE's functionality. 
